...
def evaluate_detections(all_detections, ground_truth):
    ...
    :param all_detections: List of all detections made by the system
    :param ground_truth: List of actual products in the video/images
...
def run_experiment(config, video_path, ground_truth, max_frames=300):
    ...
    all_detections = system.process_video(video_path, max_frames)
...
def main():
    ...
    # This should be the actual list of products in your test video
    ground_truth = [
